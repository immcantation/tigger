...
#'
#' \code{inferGenotypeBayesian} infers an subject's genotype applying a Bayesian framework with Dirichlet prior 
...
#' data(germline_ighv)
#' data(novel_df)
#' inferGenotypeBayesian(sample_db, find_unmutated = TRUE, germline_db = germline_ighv,
#'               novel_df = novel_df)
#' 

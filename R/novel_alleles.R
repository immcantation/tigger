...
#'           returned matrix
#' @param    nt_max the last nucleotide position to be included in the returned
#'           matrix
#' @param    min_seqs the minimum number of total sequences (within the desired
#'           mutational range and nucleotide range) required for the function
#'           to return a value
#' @param    min_frac the minimum fraction of sequences that must have usable
#'           nucleotides in a given position for that position to not be made
#'           \code{NA}
#' @param    verbose if \code{TRUE}, a message will be printed when the input
#'           causes a value of \code{NULL} to be returned
...
#'           returned
#' @param    alpha the alpha cutoff that should be used in calculating the
...
#'
#' \code{insertPolymorphisms} inserts nucleotides in the desired locations of a
#' provided sequence.
#' 
#' 
